document.addEventListener('DOMContentLoaded', function() {
    const recommendedPlaces = [
        { id: 1, image: 'toraja.png', title: 'Tana Toraja', description: 'Indonesia, Sulawesi Selatan', link: 'toraja.html'},
        { id: 2, image: 'mks.jpg', title: 'Kota Makassar', description: 'Indonesia, Sulawesi Selatan', link: 'toraja.html'},
        { id: 3, image: 'malino.jpg', title: 'Malino', description: 'Indonesia, Sulawesi Selatan', link: 'toraja.html'},
        { id: 4, image: 'bira.jpg', title: 'Pantai Bira', description: 'Indonesia, Sulawesi Selatan', link: 'toraja.html'},
        { id: 5, image: 'samalona.jpg', title: 'Pulau Samalona', description: 'Indonesia, Sulawesi Selatan', link: 'toraja.html'},
    ];
